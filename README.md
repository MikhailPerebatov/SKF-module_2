Задача: произвести разведыввательный анализ данных, устранить ошибки, отобрать данные для построения модели.

Таблица с данными имеет 17 столбцов с категориальными характеристиками и 13 столбцов числовыми и , в данных имеются пропуски не превышающие 11% от общего числа.
